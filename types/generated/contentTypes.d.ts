...
export interface ApiLabLab extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Ubuntu_Instructions: Schema.Attribute.Blocks;
    Ubuntu_Pull_command: Schema.Attribute.String;
    Ubuntu_Run_command: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Window_Instructions: Schema.Attribute.Blocks;
    Window_Pull_command: Schema.Attribute.String;
    Window_Run_command: Schema.Attribute.String;
  };
}
